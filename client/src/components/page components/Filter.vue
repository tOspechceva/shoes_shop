<template> 
<div>
    <button class="filter-button" @click="toggleFilter">Фильтр</button>
</div>
...
.filter-button {
    ...
    top: 120px;                     /* Отступ сверху от края окна */
    left: 250px;                    /* Отступ слева от края окна */
    ...
    z-index: 1000;                 /* Устанавливаем приоритет отображения над другими элементами */
}
